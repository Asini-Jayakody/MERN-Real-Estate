...
export default function UpdateListing() {
  ...
  return (
    <div className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3xl font-semibold my-7 text-center'>Update Listing</h1>
          <form className='flex flex-col sm:flex-row  gap-5'>
            <div className='flex flex-col gap-4 flex-1'>
              <input type="text" placeholder='name' className='p-3 border rounded-lg'  
              id='name' maxLength='62' minLength='5' required onChange={handleOnChange} value={formData.name}/>
              <textarea type="text" placeholder='description' className='p-3 border rounded-lg'  
              id='description' required onChange={handleOnChange} value={formData.description}/>
              <input type="text" placeholder='address' className='p-3 border rounded-lg'  
              id='address' required onChange={handleOnChange} value={formData.address}/>
              <div className='flex gap-6 flex-wrap'>
                ...
                <div className='flex flex-wrap gap-4'>
                  <div className='flex gap-1 items-center'>
                    ...
                    className='p-2 border border-gray-300 rounded-lg' onChange={handleOnChange} value={formData.bedrooms}/>
                    <span>Bedrooms</span>
                  </div>
                  <div className='flex gap-1 items-center'>
                    <input type="number" id='bathrooms' min={1} max={10} required 
                    className='p-2 border border-gray-300 rounded-lg' onChange={handleOnChange} value={formData.bathrooms}/>
                    <span>Bathrooms</span>
                  </div>
                  <div className='flex gap-1 items-center'>
                    <input type="number" id='regularPrice' min={1} max={1000000000} required 
                    className='p-2 border border-gray-300 rounded-lg' onChange={handleOnChange} value={formData.regularPrice}/>
                  ...
                  {formData.offer && (
                    <div className='flex gap-1 items-center'>
                      <input type="number" id='discountPrice' min={1} max={1000000000} required 
                      className='p-2 border border-gray-300 rounded-lg' onChange={handleOnChange} value={formData.discountPrice}/>
                      <div className='flex flex-col items-center'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
              ...
              hover:opacity-80 uppercase'>{creating ? 'Updating...' :'Update Listing'}</button>
